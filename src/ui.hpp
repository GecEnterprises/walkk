...
void UiLoop(GLFWwindow* window) {
    ...
    bool loading = false;
    int loadResult = -1;
    ImGuiNoise_InitOnce(275, 275, ImVec4(0.039215688f, 0.05490196f, 0.078431375f, 0.0f), ImVec4(0.9019608f, 0.7058824f, 0.3137255f, 1.0f));
   ...
   Y$c$$$c$P c$$$cc$$$c  $$'     _$$$$,   _$$$$,    
    "88"888   888   888,o88oo,.__"888"88o,"888"88o, 
     "M "M"   YMM   ""` """"YUMMM MMM "MMP"MMM "MMP" by gectheory)";
        ...
        auto cur = getCurrentAmplitude();
        ImGuiNoise_AddTime(0.01 + cur);      // or ImGuiNoise_SetTime(totalSeconds)
        ImGui::SameLine();
        ImGuiNoise_Draw(nullptr, ImVec2(275, 275), false); // shows controls + preview
